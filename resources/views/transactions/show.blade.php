        ...
        <div class="form-container">
            ...
            <div class="form-section">
                ...
                <div class="display-group">
                    ...
                    <span
                        class="display-value badge {{ $transaction->action === 'issue' ? 'badge-primary' : 'badge-success' }}">
            ...
            <!-- Condition -->
            <div class="form-section">
                <h3><i class="fas fa-info-circle"></i> Condition</h3>
                <div class="display-group">
                    <span class="display-label">Condition:</span>
                    <span class="display-value">
                        {{ $transaction->condition ? ucfirst($transaction->condition) : 'Not specified' }}
                    </span>
                </div>
            </div>
